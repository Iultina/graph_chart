...
#       """Модель Sales вместо трех моделей Year, Plan, Fact.
#       """
#     city = models.ForeignKey(City, on_delete=models.CASCADE)
#     year = models.IntegerField()
#     plan_amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Planned Sales')
#     fact_amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Actual Sales')
